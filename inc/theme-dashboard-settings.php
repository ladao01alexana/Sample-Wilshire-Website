...
function sydney_free_vs_pro_html() {
	...
	<p>
		<a href="https://athemes.com/sydney-pricing/?utm_source=theme_table&utm_medium=button&utm_campaign=Sydney" class="thd-button button">
...
function sydney_dashboard_settings( $settings ) {
	...
	$settings['promo_link']   = 'https://athemes.com/sydney-pricing/?utm_source=theme_info&utm_medium=link&utm_campaign=Sydney';
	...
	$settings['support_pro_link'] = 'https://athemes.com/sydney-pricing/?utm_source=theme_info&utm_medium=link&utm_campaign=Sydney';
...
function sydney_demos_settings( $settings ) {
	...
	$settings['pro_link']  = 'https://athemes.com/sydney-pricing/?utm_source=theme_table&utm_medium=button&utm_campaign=Sydney';
